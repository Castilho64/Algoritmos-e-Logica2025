print("Atividade 02 - Aula 11")

n_total_questoes = int(input("Digite um número total de questões do quiz: "))

pontuacao_bruta = 0
erros_consecutivos = 0

for i in range(1, n_total_questoes + 1):
    pontuacao = float(input(f"Digite a pontuação da questão {i} (0.0 a 10.0): "))
...
print(f"A sua Pontuação Bruta foi: {pontuacao_bruta} \n E sua Pontuação Final Ajustada foi de: {pontuacao_ajustada}.")
